    ...
    <header className="sticky top-0 z-20 bg-paper/85 backdrop-blur border-b border-ink-line">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 h-14 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <Link
            to="/events/new"
            className="inline-flex items-center gap-1.5 bg-ink text-paper rounded-md px-3 py-1.5 text-sm font-medium hover:bg-ink-soft transition-colors"
          >
            <PlusIcon />
            Add
          </Link>
        ...
        <div className="sm:hidden border-t border-ink-line bg-paper">
          <nav className="max-w-3xl mx-auto px-5 py-3 grid gap-1 text-sm">
            ...
            <Link
              to="/events/new"
              onClick={close}
              className="inline-flex items-center justify-center gap-1.5 bg-ink text-paper rounded-md px-3 py-2 text-sm font-medium"
            >
              <PlusIcon />
              Add event
            </Link>
            {email && (
              <div className="px-2 pt-2 text-xs text-ink-faint truncate">{email}</div>
            )}
            <button
              type="button"
